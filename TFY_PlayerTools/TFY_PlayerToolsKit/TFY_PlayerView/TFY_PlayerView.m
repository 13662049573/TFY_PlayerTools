...
/// 竖屏控制层的View
@property (nonatomic, strong) TFY_PortraitView *portraitControlView;
/// 横屏控制层的View
@property (nonatomic, strong) TFY_LandScapeView *landScapeControlView;
/// 加载loading
...
- (void)sliderValueChangingValue:(CGFloat)value isForward:(BOOL)forward {
    ...
    if (forward) {
        self.fastImageView.image = Player_Image(@"fast_forward");
    } else {
        self.fastImageView.image = Player_Image(@"fast_backward");
    }
