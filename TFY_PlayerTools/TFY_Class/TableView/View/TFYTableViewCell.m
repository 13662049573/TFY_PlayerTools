...
@property (nonatomic, weak) id<TFYTableViewCellDelegate> delegate;
...
@implementation TFYTableViewCell
...
- (void)setLayout:(TFYTableViewCellLayout *)layout {
    _layout = layout;
