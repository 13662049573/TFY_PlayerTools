...
@implementation TFYCustomControlView
...
- (void)showTitle:(NSString *)title coverURLString:(NSString *)coverUrl fullScreenMode:(FullScreenMode)fullScreenMode {
    UIImage *placeholder = [TFY_ITools imageWithColor:[UIColor colorWithRed:220/255.0 green:220/255.0 blue:220/255.0 alpha:1] size:self.coverImageView.bounds.size];
    [self resetControlView];
    [self layoutIfNeeded];
